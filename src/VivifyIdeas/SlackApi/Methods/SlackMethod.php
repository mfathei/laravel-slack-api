...
use VivifyIdeas\SlackApi\Contracts\SlackApi;
...
abstract class SlackMethod
{
    ...
    /**
     * @var \VivifyIdeas\SlackApi\Contracts\SlackApi
     */
    protected $api;
    ...
    protected $cachePrefix = '__vivify_slackc_';

    /**
     * @param \VivifyIdeas\SlackApi\Contracts\SlackApi  $api
     * @param Cache $cache
     */
    ...
    /**
     * Returns the api.
     * @return \VivifyIdeas\SlackApi\Contracts\SlackApi
     */
